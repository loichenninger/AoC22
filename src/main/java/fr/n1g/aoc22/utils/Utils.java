...
public class Utils {
    ...
    public static String[][] getStringMatrix(String input, String separateur) {
        return getLine(input).map(ligne -> ligne.split(separateur)).toArray(String[][]::new);
    }

    public static Integer[][] getIntegerMatrix(String input, String separateur) {
